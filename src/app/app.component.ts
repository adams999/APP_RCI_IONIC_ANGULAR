...
export class AppComponent {
  ...
  public cliente = {
    "client": "RCI",
    "colors_platform": "{\n  \"COLOR_MENU_BACKEND\": \"#892501\",\n  \"color_tr_table\": \"#bababa\",\n  \"color_font_tr\": \"#e6e1e1\",\n  \"color_login\": \"#f6f6f6\",\n  \"color_menu\": \"#454141\",\n  \"color_menu_barra\": \"#5b5d61\",\n  \"color_menu_barra_hover\": \"#521f12\",\n  \"color_font_tab\": \"#5c595a\",\n  \"color_email_font\": \"#f04a13\",\n  \"email_shadow_table\": \"#736d6d\"\n}",
    "email": null,
    "id_broker": "16",
    "id_country": "MX",
    "img_cliente": "Arrayimg_cliente201609071637170722.png",
    "logo_agencia": "https://ilsadmin.com/app/upload_files/logo_clientes/Arrayimg_cliente201609071637170722.png",
    "prefix": "RC",
    "type_platform": "1",
    "urlPrueba": null,
    "web": "https://rcibywta.com"
  };
  ...
  constructor(public platform: Platform,
    ...
    network.onConnect().subscribe(() => {
      ...
      this.userType ? this.navCtrl.navigateRoot('/list-orders') : navCtrl.navigateRoot('/login/RC');;
  ...
  sessionColores(colorsPlatform, cliente) {
    if (localStorage.getItem('paramAgency') != 'N/A' && localStorage.getItem('paramAgency')) {
      ...
      localStorage.setItem("nomClient", 'RCI');
    }
  }
