  ...
  async modalFromPago() {
    const modal = await this.modalCtrl.create({
      ...
      componentProps: {
        dataPlan: {
          "valorMenor": "20.520",
          "subTotalMenores": "20.520",
          "valorMayor": "30.780",
          "subTotalMayor": "0.000",
          "costoMenor": "8.400",
          "subTotalMenores_costo": "8.400",
          "costoMayor": "12.600",
          "subTotalMayor_costo": "0.000",
          "numero_menores": 1,
          "numero_mayores": 0,
          "tiepoid": "753",
          "total": "20.52",
        ...
        dataVuelo: ["AL", "1", "27/05/2020", "10/06/2020", "Viajes por día", "24", [45], null, "Albania", "World Wide"],
        rangEd: {
          edadMin: '15',
          edadMax: '85'
        },
  ...
  async modalPrecios(precios) {
    ...
    const modal = await this.modalCtrl.create({
      ...
      componentProps: {
        ...
        parametros: ["AL", "41", "24/06/2020", "27/07/2020", "Viajes por día", "24", [45, 20, 70], null, "Albania", "World Wide"],
        paises: 'AL',
        idPreOrden: 825554
      }
    });
